...
class cdCompanyGUI
{
	...
	function executeCommand()
	{
		...
		else if (count($this->user_admin_centers) > 0)
		{
			// cdc-ma or higher
	...
	function listCompanies()
	{
		...
		$ilToolbar->addButton($this->pl->txt("add_company"),
	...
	function listUsers()
	{
		...
		if (ilCDPermWrapper::checkUserCreationPossible($this->company->getId()))
		{
			...
			$ilToolbar->addButton($this->pl->txt("add_user"),
		...
		$ilToolbar->addButton($this->pl->txt("export_excel"),
		...
		$table = new ilCompanyUserTableGUI($this, "listUsers", $this->pl,
			$this->user_admin_centers, $this->company);
		$tpl->setContent($table->getHTML());
	 ...
	 * @return
	 */
	function getCompanyUserProfile()
	{
...
// cdpatch end
	...
	function showLearnData()
	{
		...
		// self evaluation
		include_once("./Services/Skill/classes/class.ilSkillSelfEvaluationGUI.php");
	 ...
	 */
	function confirmCompanyUserDeletion()
	{
		global $ilCtrl, $tpl, $lng;
	...
	*/
	...
	function showOralTarget()
	{
		...
		$tab = new cdOralTargetTableGUI($this, "showOralTarget",
			$this->pl, (int) $this->user_id);
...
//	var_dump($_POST); exit;
	 ...
	 */
	function confirmOralTargetDelete()
	{
		global $ilCtrl, $tpl, $lng;
	...
	function changeCompany()
	{
		...
		include_once("./Services/CD/classes/class.ilCDUserUtil.php");
	 ...
	 * Confirm changing company of users
	 */
	function confirmPublishPartEval()
	{
		global $ilCtrl, $tpl, $lng;
