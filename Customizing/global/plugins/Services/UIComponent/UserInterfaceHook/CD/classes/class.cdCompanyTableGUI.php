...
class cdCompanyTableGUI extends ilTable2GUI
{
	 ...
	 * Constructor
	 */
	function __construct($a_parent_obj, $a_parent_cmd, $a_pl, $a_user_admin_centers = null)
	{
	 ...
	 * @return
	 */
	function getCompanies($a_user_admin_centers = null)
	{
		$comp = cdCompany::getAllCompanies(true, $a_user_admin_centers,
			$this->filter);
	...
	protected function fillRow($a_set)
	{
		...
		$this->tpl->setVariable("CMD_LIST_USERS",
