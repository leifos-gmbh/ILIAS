...
class cdCourseType
{
	...
	function read()
	{
		...
		$set = $ilDB->query("SELECT * FROM cd_course_type WHERE ".
	...
	function update()
	{
		...
		$ilDB->manipulate("UPDATE cd_course_type SET ".
	...
	function delete()
	{
		...
		$ilDB->manipulate("DELETE FROM cd_course_type WHERE "
			." id = ".$ilDB->quote($this->getId(), "integer")
			);
	 ...
	 */
	static function getAllCourseTypes($a_lang = "")
	{
		global $ilDB;
		...
		$set = $ilDB->query("SELECT * FROM cd_course_type ".$where." ORDER BY title"
			);
	...
	protected static function lookupProperty($a_id, $a_prop)
	{
		...
		$set = $ilDB->query("SELECT $a_prop FROM cd_course_type WHERE ".
