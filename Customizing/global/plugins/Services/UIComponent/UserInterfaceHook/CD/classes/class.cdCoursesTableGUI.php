...
class cdCoursesTableGUI extends ilTable2GUI
{
	 ...
	 * Constructor
	 */
	function __construct($a_parent_obj, $a_parent_cmd, $a_pl, $a_items = "")
	{
	...
	protected function fillRow($a_set)
	{
		...
		$html = $this->item_list_gui->getListItemHTML($a_set["ref_id"],
			$a_set["obj_id"], $a_set["title"], $a_set["description"]);
