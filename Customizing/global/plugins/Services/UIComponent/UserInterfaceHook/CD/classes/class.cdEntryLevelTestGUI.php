...
class cdEntryLevelTestGUI
{
	 ...
	 */
	function listEntryLevelTests()
	{
		global $tpl, $ilToolbar, $ilCtrl, $lng;

		$ilToolbar->addButton($this->pl->txt("add_entry_level_test"),
	 ...
	 */
	function confirmEntryLevelTestDeletion()
	{
		...
		else
		{
			...
			{
				$cgui->addItem("entry_level_test_id[]", $i,
