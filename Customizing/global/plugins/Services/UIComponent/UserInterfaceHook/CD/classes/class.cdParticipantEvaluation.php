...
class cdParticipantEvaluation
{
	 ...
	 */
	function setParticipantId($a_val)
	{
	 ...
	 */
	function setAfterXLessons($a_val)
	{
	 ...
	 */
	function setTestAttendance($a_val)
	{
	 ...
	 */
	function setRecommendedLevel($a_val)
	{
	 ...
	 */
	function setCreationDate($a_val)
	{
	...
	public function update()
	{
		...
		$ilDB->update("cd_participant_eval", $fields,
	...
	public function delete()
	{
		...
		$ilDB->manipulate("DELETE FROM cd_participant_eval WHERE "
			." id = ".$ilDB->quote($this->getId(), "integer")
			);
	...
	protected static function lookupProperty($a_id, $a_prop)
	{
		...
		$set = $ilDB->query("SELECT $a_prop FROM cd_participant_eval WHERE ".
	...
	static function countEvals($a_user_id, $a_course_id)
	{
		...
		$set = $ilDB->query("SELECT count(id) cnt FROM cd_participant_eval ".
