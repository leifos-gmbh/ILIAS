...
class cdParticipantEvaluationGUI
{
	 ...
	 * @return
	 */
	function readParticipantEvaluation()
	{
...
//var_dump($this->needs_analysis);
	 ...
	 * @return
	 */
	function listParticipantEvaluations()
	{
		global $tpl, $ilToolbar, $ilCtrl, $lng, $ilTabs;
		
		$ilTabs->clearTargets();
		$ilTabs->setBackTarget($lng->txt("members"),
			$ilCtrl->getLinkTargetByClass("ilobjcoursegui", "members"));

		$ilToolbar->addButton($this->pl->txt("add_participant_evaluation"),
		$ilCtrl->getLinkTarget($this, "addParticipantEvaluation"));

		$this->pl->includeClass("class.cdParticipantEvaluationTableGUI.php");
		$table = new cdParticipantEvaluationTableGUI($this, "listParticipantEvaluations", $this->pl,
			$this->course_id);
	 ...
	 */
	function addParticipantEvaluation()
	{
		global $tpl, $ilCtrl;
	 ...
	 */
	function editParticipantEvaluation()
	{
		global $tpl, $ilCtrl, $ilTabs;

		$ilTabs->clearTargets();
		$ilTabs->setBackTarget($this->pl->txt("evaluation_list"),
...
//echo "-".(int) $_GET["member_id"]."-"; exit;
	 ...
	 */
	function updateParticipantEvaluation()
	{
	 ...
	 */
	function confirmParticipantEvaluationDeletion()
	{
	 ...
	 * @return
	 */
	function deleteParticipantEvaluation()
	{
		global $ilCtrl, $lng;
