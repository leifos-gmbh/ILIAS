...
class cdParticipantEvaluationTableGUI extends ilTable2GUI
{
	 ...
	 * Constructor
	 */
	function __construct($a_parent_obj, $a_parent_cmd, $a_pl, $a_course_id)
	{
		...
		$this->setData(cdParticipantEvaluation::getPEsOfUser((int) $_GET["member_id"],
			$this->course_id));
	...
	protected function fillRow($a_set)
	{
		...
		{
			$this->tpl->setVariable("VAL_UPDATED",
