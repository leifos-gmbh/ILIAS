...
//		$this->readCourseType();
	...
	function listConfirmations()
	{
		...
		$ilToolbar->addButton($this->pl->txt("add_confirmation_template"),
	...
	*/
	 ...
	 */
	function confirmConfirmationDeletion()
	{
	...
	*/
	function confirmDeleteConfirmations()
	{
		global $ilCtrl, $tpl, $lng;
	 ...
	 * @return
	 */
	function downloadConfirmationTemplate()
	{
		$this->pl->includeClass("class.cdParticipationConfirmation.php");
