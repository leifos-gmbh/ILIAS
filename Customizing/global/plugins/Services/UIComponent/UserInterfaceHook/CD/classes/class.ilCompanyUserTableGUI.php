...
class ilCompanyUserTableGUI extends ilTable2GUI
{
	...
	* Constructor
	*/
	function __construct($a_parent_obj, $a_parent_cmd, $a_pl, $a_user_admin_centers,
		$a_company)
	{
