...
$ilDB->addTableColumn("cd_oral_target", "course_type",
		array(
		'type' => 'integer',
		'length' => 4,
		'notnull' => true
...
$ilDB->addTableColumn("cd_company", "parent_company",
		array(
		'type' => 'integer',
		'length' => 4,
		'default' => 0,
...
$ilDB->addTableColumn("cd_company", "creation_user",
		array(
		'type' => 'integer',
		'length' => 4,
		'default' => 0,
...
$ilDB->addTableColumn("cd_company", "title_amendment",
		array(
			'type' => 'clob'
		)
);
...
$ilDB->addTableColumn("cd_company", "address_amendment",
		array(
			'type' => 'clob'
		)
);
...
<?php
	...
	$ilDB->addTableColumn('cd_participant_eval', "recommended_level",
		array(
		"type" => "text",
		"notnull" => false,
		"length" => 2
...
<#33>
<?php
	$ilDB->addTableColumn('cd_participant_eval', "test_level",
		array(
		"type" => "text",
		"notnull" => false,
		"length" => 1000
...
<#34>
<?php
	$ilDB->modifyTableColumn('cd_participant_eval', 'starting_cef',
		array("type" => "text", "length" => 10, "notnull" => false));
	$ilDB->modifyTableColumn('cd_participant_eval', 'current_cef',
		array("type" => "text", "length" => 10, "notnull" => false));
	$ilDB->modifyTableColumn('cd_participant_eval', 'recommended_level',
		array("type" => "text", "length" => 10, "notnull" => false));
?>
<#35>
<?php
	$ilDB->addTableColumn('cd_participant_eval', "published",
		array(
			"type" => "integer",
			"length" => 1,
			"notnull" => true,
...
<#36>
<?php
	$ilDB->addTableColumn('cd_oral_target', "tdate",
		array(
			"type" => "date",
			"notnull" => false
		));
...
<#38>
<?php
	$ilDB->addTableColumn('cd_oral_target', "id",
		array(
			"type" => "integer",
			"notnull" => true,
			"length" => 4,
