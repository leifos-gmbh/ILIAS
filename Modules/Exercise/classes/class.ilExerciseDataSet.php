			...
			switch ($a_version)
			{
				...
				case "5.3.0":
					$this->getDirectDataFromQuery("SELECT id, exc_id exercise_id, type, time_stamp deadline, deadline2,".
						...
						" fb_date_custom, rmd_submit_status, rmd_submit_start, rmd_submit_freq, rmd_grade_status, rmd_grade_start, rmd_grade_freq,".
						" peer_rmd_status, peer_rmd_start, peer_rmd_freq".
						" FROM exc_assignment".
						" WHERE ".$ilDB->in("exc_id", $a_ids, false, "integer"));
					break;
			}
