...
class CodeDBRepo
{
    ...
    public function deleteAll(int $survey_id) : void
    {
        ...
        $db->manipulateF("DELETE FROM svy_anonymous WHERE " .
            " survey_fi = %s",
            ["integer"],
            [$survey_id]
        );
    ...
    {
        $db = $this->db;
        $set = $db->queryF("SELECT anonymous_id FROM svy_anonymous " .
    ...
    public function getAll(int $survey_id) : array
    {
        ...
        $set = $db->queryF("SELECT survey_key FROM svy_anonymous " .
            " WHERE survey_fi = %s ",
            ["integer"],
            [$survey_id]
        );
    ...
    public function getAllData(int $survey_id) : array
    {
        ...
        $set = $db->queryF("SELECT * FROM svy_anonymous " .
            " WHERE survey_fi = %s ",
            ["integer"],
            [$survey_id]
        );
