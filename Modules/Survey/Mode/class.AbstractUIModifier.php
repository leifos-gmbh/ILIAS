...
abstract class AbstractUIModifier implements UIModifier
{
    ...
    protected function getPanelText(
        ...
        \ilSurveyEvaluationResults $question_res) : string
    {
        $a_results = $a_eval->getResults();
        $question = $question_res->getQuestion();
        $lng = $this->service->ui()->lng();
    ...
    protected function getPanelCard(\ilSurveyEvaluationResults $question_res) : \ILIAS\UI\Component\Card\Standard
    {
        ...
        $card_table_tpl = new \ilTemplate(
            "tpl.svy_results_details_card.html", true, true, "Modules/Survey/Evaluation");
        ...
        return $ui_factory->card()
                          ...
                          ->withSections(array($ui_factory->legacy($card_table_tpl->get()))
                          );
    }
