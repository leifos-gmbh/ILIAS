...
class ilObjSurvey extends ilObject
{
    ...
    */
     ...
     */
    function setCalculateSumScore($a_val)
    {
    ...
    * @see $invitation
    */
    public function setInvitation($invitation = 0)
    {
        $ilDB = $this->db;
        ...
        } elseif ($invitation == self::INVITATION_ON) {
    ...
    * @see $invitation_mode
    */
    public function setInvitationMode($invitation_mode = 0)
    {
    ...
    * @see $invitation_mode
    */
    public function setInvitationAndMode($invitation = 0, $invitation_mode = 0)
    {
        $this->invitation_mode = $invitation_mode;
    ...
    */
     ...
     * @return
     */
    public function getMaxSumScore()
    {
        $sum_score = 0;
