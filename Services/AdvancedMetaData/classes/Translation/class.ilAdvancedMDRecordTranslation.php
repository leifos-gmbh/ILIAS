...
class ilAdvancedMDRecordTranslation
{
     ...
     */
    public function __construct(int $record_id, string $title, string $description, string $lang_key, bool $lang_default)
    {
        global $DIC;
     ...
     * @return bool
     */
    public function isLangDefault() : bool
    {
    ...
    public function update()
    {
        $query = 'update ' . self::TABLE_NAME . ' ' .
            ...
            'lang_default = ' . $this->db->quote((int) $this->isLangDefault(), ilDBConstants::T_INTEGER) . ', ' .
    ...
    {
        $query = 'insert into ' . self::TABLE_NAME . ' (record_id, title, lang_code, lang_default, description) ' .
            'values (  ' .
            ...
            $this->db->quote((int) $this->isLangDefault(), ilDBConstants::T_INTEGER) . ', ' .
