...
class ilCDDBCreator
{
	...
	function createTables()
	{
		...
		if ($cd_db <= 35)
		{
			$ilDB->modifyTableColumn('cd_trainer_el', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
			$ilDB->modifyTableColumn('cd_trainer_fe', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
			$ilDB->modifyTableColumn('cd_trainer_il', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
			$ilDB->modifyTableColumn('cd_trainer_ls', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
			$ilDB->modifyTableColumn('cd_trainer_mtl', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
			$ilDB->modifyTableColumn('cd_trainer_tl', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
			$ilDB->modifyTableColumn('cd_trainer_tt', 'id',
				array("type" => "integer", "length" => 4, "notnull" => true));
