...
// cdpatch end (only new fields)
	 ...
	 * Constructor
	 */
	function __construct($a_cd_plugin)
	{
	...
	*/
	function addStandardFieldsToForm($a_form, $a_user = NULL, array $custom_fields = NULL, $a_trainer = NULL)
	{
	 ...
	 * @return
	 */
	function addFormField($a_form, $f, $p, $a_user = false)
	{
		global $lng;
	 ...
	 * @return
	 */
	function createUserFromForm($a_form, $a_user)
	{
		global $ilSetting;
	 ...
	 * @return
	 */
	function updateUserFromForm($a_form, $a_user)
	{
		global $ilSetting;
	 ...
	 * @return
	 */
	function setUserValuesFromForm($a_user, $a_form)
	{
	 ...
	 * @return
	 */
	function setTrainerValuesFromForm($a_trainer, $a_form)
	{
	 ...
	 * @return
	 */
	function setTrainerValuesIntoForm($a_form)
	{
		...
		foreach ($this->getStandardFields() as $f => $def)
		{
			...
			else if ($def["table"] == "usr_data" || $f == "language")
			{
				$m = $def["method"];
...
//		echo "+".$this->trainer->cd_trainer[$f]."+";
	 ...
	 * @return
	 */
	static function logEditing($a_trainer_id)
	{
		global $ilDB, $ilUser;
	 ...
	 * @return
	 */
	static function getChangeLog($a_trainer_id)
	{
		global $ilDB;
		
		$set = $ilDB->query("SELECT * FROM cd_trainer_log ".
