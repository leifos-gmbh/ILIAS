...
*/
class ilFeeInputGUI extends ilSubEnabledFormPropertyGUI implements ilTableFilterItem, ilToolbarItem, ilMultiValuesItem
{
	...
	* @param	string	$a_value	Value
	*/
	function setDateValues($a_value)
	{
	...
	*/
	function render($a_mode = "")
	{
		...
		$tpl = new ilTemplate("tpl.prop_fee.html", true, true, "Services/CD");
		...
		$tpl->setVariable("TXT_DATE", $lng->txt("cd_date"));
		$tpl->setVariable("VAL", $this->getValue());
