...
class ParagraphStyleSelector
{
     ...
     * Constructor
     */
    public function __construct($ui_wrapper)
    {
        global $DIC;
     ...
     * Get style selector
     */
    public function getStyleSelector($a_selected, $a_chars, $a_use_callback = false)
    {
        ...
        foreach ($a_chars as $char => $char_lang) {
            ...
            $buttons[] = $ui_wrapper->getButton($html, "par-action", "par.class", ["class" => $char]);
        }
