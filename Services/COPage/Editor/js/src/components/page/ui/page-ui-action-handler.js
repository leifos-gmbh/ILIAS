  ...
  handle(action, model) {
    ...
    switch (action.getType()) {
      ...
      case "component.insert":
        ...
        if (!["Paragraph", "LayoutTemplate", "PlaceHolder", "Grid", "MediaObject", "Section"].includes(model.getCurrentPCName())) {
        ...
        // generic
        if (["LayoutTemplate", "PlaceHolder", "Grid", "MediaObject", "Section"].includes(model.getCurrentPCName())) {
