...
{
    public function withIndex(int $index): ilIndexInterface;

    public function withComparison(ilFilePathComparisonInterface $comparison): ilIndexInterface;

    public function withIndexingFromEndEnabled(bool $enabled): ilIndexInterface;
}
