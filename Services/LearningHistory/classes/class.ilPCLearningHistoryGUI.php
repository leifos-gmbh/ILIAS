...
class ilPCLearningHistoryGUI extends ilPageContentGUI
{
	 ...
	 * Constructor
	 */
	function __construct(ilPageObject $a_pg_obj, ilPCLearningHistory $a_content_obj = null, $a_hier_id = "", $a_pc_id = "")
	{
		global $DIC;
	 ...
	 * @return
	 */
	static public function getPlaceholderPresentation()
	{
		global $DIC;
