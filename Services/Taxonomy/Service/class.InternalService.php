...
class InternalService
{
    ...
    static protected ?InternalDataService $data = null;
    static protected ?InternalRepoService $repo = null;
    static protected ?InternalDomainService $domain = null;
    static protected ?InternalGUIService $gui = null;
