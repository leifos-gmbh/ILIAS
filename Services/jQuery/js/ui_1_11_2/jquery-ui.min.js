...
var dialog = $.widget( "ui.dialog", {
	...
	_createTitlebar: function() {
		...
		this.uiDialogTitlebarClose = $( "<button type='button'></button>" )
			...
			.appendTo( this.uiDialogTitlebar );console.log($( "<button type='button'></button>").button, this.options.closeText, this.uiDialogTitlebarClose.html());
	...
	_destroyOverlay: function() {
		...
		if ( this.overlay ) {
			...
			if ( !overlays ) {
				this.document
					.unbind( "focusin" ).removeData( "ui-dialog-overlays" );
			} else {
