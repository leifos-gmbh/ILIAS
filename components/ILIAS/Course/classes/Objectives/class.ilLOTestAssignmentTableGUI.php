...
class ilLOTestAssignmentTableGUI # extends ilTable2GUI
{
    ...
    public const TABLE_COL_TITLE = 'title';
    public const TABLE_COL_COURSE_OBJECTIVES = 'objective';
    public const TABLE_COL_SELECTION_OF_TEST_QUESTIONS = 'ttype';
    public const TABLE_COL_QESTIONS = 'qstqpl';
    protected const ALL_OBJECTS = "ALL_OBJECTS";
    protected const TABLE_ID = 'lotstasstbl';
    protected const ROW_ID = 'row_ids';
    protected const TABLE_ACTION_ID = 'table_action';
    protected const TABLE_ACTION_CONFIRM_DELETE_TESTS = 'confirmDeleteTests';
    protected const TABLE_ACTION_CONFIRM_DELETE_TEST = 'confirmDeleteTest';
    protected const ACTION_CONFIRM_DELETE_TEST = "delete_selected_test";
    protected const ACTION_CONFIRM_DELETE_TESTS = "delete_selected_tests";
    protected const LNG_TABLE_COL_TITLE = 'title';
    protected const LNG_TABLE_COL_COURSE_OBJECTIVES = 'crs_objectives';
    protected const LNG_TABLE_COL_SELECTION_OF_TEST_QUESTIONS = 'crs_loc_tbl_tst_type';
    protected const LNG_TABLE_COL_QESTIONS = 'crs_loc_tbl_tst_qst_qpl';
    protected const LNG_TABLE_ACTION_CONFIRM_DELETE_TESTS = 'crs_loc_delete_assignment';
    protected const LNG_TABLE_ACTION_CONFIRM_DELETE_TEST = 'crs_loc_delete_assignment';
