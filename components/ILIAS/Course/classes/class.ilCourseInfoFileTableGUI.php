...
{
    public const TABLE_COL_FILENAME = 'filename';
    public const TABLE_COL_FILESIZE = 'filesize';
    public const TABLE_COL_FILETYPE = 'filetype';
    protected const ALL_OBJECTS = "ALL_OBJECTS";
    protected const TABLE_ACTION_CONFIRM_DELETE = 'confirm_delete';
    protected const TABLE_ACTION_DELETE = 'delete';
    protected const LNG_TABLE_COL_FILENAME = 'filename';
    protected const LNG_TABLE_COL_FILESIZE = 'filesize';
    protected const LNG_TABLE_COL_FILETYPE = 'filetype';
    protected const LNG_TABLE_ACTION_CONFIRM_DELETE = 'delete';
    protected const LNG_TABLE_TITLE = 'crs_info_download';
    protected const TABLE_ID = "crsfltbl";
