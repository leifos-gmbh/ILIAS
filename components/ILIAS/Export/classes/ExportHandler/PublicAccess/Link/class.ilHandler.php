...
use ILIAS\Export\ExportHandler\ilStaticUrlHandler as ilExportHandlerStaticUrlHandler;
...
class ilHandler extends BaseHandler implements ilExportHandlerPublicAccessLinkHandlerInterface, StaticURLHandler
{
