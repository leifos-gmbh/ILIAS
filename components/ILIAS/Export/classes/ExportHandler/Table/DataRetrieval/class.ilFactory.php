...
use ILIAS\Export\ExportHandler\I\Table\DataRetrieval\ilFactoryInterface as ilExportHandlerTableDataRetrievalFactoryInterface;
use ILIAS\Export\ExportHandler\I\Table\DataRetrieval\ilHandlerInterface as ilExportHandlerTableDataRetrievalInterface;
use ILIAS\Export\ExportHandler\Table\DataRetrieval\ilHandler as ilExportHandlerTableDataRetrieval;
use ilObject;

class ilFactory implements ilExportHandlerTableDataRetrievalFactoryInterface
{
