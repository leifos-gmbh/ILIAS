    ...
    public function getRows(
        ...
        switch ($column_name) {
            ...
            case ilExportHandlerTableInterface::TABLE_COL_PUBLIC_ACCESS:
                ...
                break;
            case ilExportHandlerTableInterface::TABLE_COL_PUBLIC_ACCESS_POSSIBLE:
                $comparator = function (ilExportHandlerFileInfoInterface $f1, ilExportHandlerFileInfoInterface $f2) {
                    if ($f1->getPublicAccessPossible() and $f2->getPublicAccessPossible()) {
                        return 0;
                    };
                    return $f1->getPublicAccessPossible() ? 1 : -1;
                };
                break;
        }
