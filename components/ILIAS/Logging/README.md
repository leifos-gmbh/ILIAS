...
The Logging components providers loggers to other components in ILIAS. Those Loggers are [PSR-3](https://www.php-fig.org/psr/psr-3/)
compliant, and use [Monolog](https://github.com/Seldaek/monolog).
