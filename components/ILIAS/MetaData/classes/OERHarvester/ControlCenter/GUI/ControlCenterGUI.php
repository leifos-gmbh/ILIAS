...
use ILIAS\MetaData\OERHarvester\ControlCenter\GUI\Content\ContentFactoryInterface;
...
class ControlCenterGUI
{
    ...
    {
        echo $this->ui_renderer->renderAsync($this->ui_factory->prompt()->state()->redirect($content));
        exit;
    }
