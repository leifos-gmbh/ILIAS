 ...
 */
abstract class AbstractRenderer extends AbstractComponentRenderer
{
    ...
    abstract protected function wrapInContext(
        FormInput $component,
        string $input_html,
    ...
    abstract protected function maybeDisable(FormInput $component, Template $tpl): void;

    final protected function applyName(FormInput $component, Template $tpl): ?string
    {
    ...
    final protected function bindJSandApplyId(FormInput|ProxyFilterField $component, Template $tpl): string
    {
     ...
     */
    final protected function applyValue(FormInput $component, Template $tpl, callable $escape = null): void
    {
    ...
    final protected function escapeSpecialChars(): Closure
    {
        return function ($v) {
    ...
    final protected function htmlEntities(): Closure
    {
        return function ($v) {
            // with declare(strict_types=1) in place,
    ...
    final protected function renderTextField(F\Text $component, RendererInterface $default_renderer): string
    {
        ...
        return $this->wrapInContext($component, $tpl->get(), $default_renderer, $id);
    }

    final protected function renderNumericField(F\Numeric $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderCheckboxField(F\Checkbox $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderOptionalGroup(F\OptionalGroup $component, RendererInterface $default_renderer): string
    {
        $tpl = $this->getTemplate("tpl.checkbox.html", true, true);
        $this->applyName($component, $tpl);
        ...
        return $this->wrapInContext($component, $tpl->get(), $default_renderer, $id, $dependant_group_html);
    }

    final protected function renderSwitchableGroup(F\SwitchableGroup $component, RendererInterface $default_renderer): string
    {
        ...
        return $this->wrapInContext($component, $tpl->get(), $default_renderer);
    }

    final protected function renderTagField(F\Tag $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderPasswordField(F\Password $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderSelectField(F\Select $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderMarkdownField(F\Markdown $component, RendererInterface $default_renderer): string
    {
        ...
        return $this->wrapInContext($component, $markdown_tpl->get(), $default_renderer, $textarea_id);
    }

    final protected function renderTextareaField(F\Textarea $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function getPreparedTextareaTemplate(F\Textarea $component): Template
    {
    ...
    final protected function renderRadioField(F\Radio $component, RendererInterface $default_renderer): string
    {
        $tpl = $this->getTemplate("tpl.radio.html", true, true);
        $id = $this->bindJSandApplyId($component, $tpl);
    ...
    final protected function renderMultiSelectField(F\MultiSelect $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderDateTimeField(F\DateTime $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderDurationField(F\Duration $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderSection(F\Section $section, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderUrlField(F\Url $component, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderFileField(FI\File $input, RendererInterface $default_renderer): string
    {
    ...
    final protected function renderHiddenField(F\Hidden $input, RendererInterface $default_renderer): string
    {
     ...
     * @inheritdoc
     */
    final public function registerResources(ResourceRegistry $registry): void
    {
     ...
     */
    final protected function setSignals(F\FormInput $input)
    {
        $signals = null;
     ...
     */
    final protected function getTransformedDateFormat(
    ...
    final protected function renderFilePreview(
        FI\File $file_input,
    ...
    final protected function initClientsideFileInput(FI\File $input): FI\File
    {
    ...
    final protected function initClientsideRenderer(
    ...
    final protected function replaceTemplateIds(string $template_html): string
    {
     ...
     */
    final protected function prepareDropzoneJsMimeTypes(array $mime_types): string
    {
        $mime_type_string = '';
    ...
    final protected function renderColorPickerField(F\ColorPicker $component, RendererInterface $default_renderer): string
    {
