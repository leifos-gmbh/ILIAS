    ...
    <div class="panel-heading ilHeader">
        ...
        <div class="panel-viewcontrols l-bar__space-keeper">
            <div class="il-viewcontrol-sortation l-bar__element" id="id_2">
                <div class="dropdown"><button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" id="id_5"  aria-label="actions" aria-haspopup="true" aria-expanded="false" aria-controls="id_5_menu"><span class="caret"></span></button>
